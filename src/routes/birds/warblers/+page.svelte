<script module>
	// waxwings
	import w01 from '$lib/images/birds/2026/09/2026-09-19-142029.jpg?enhanced';
	import w02 from '$lib/images/birds/2026/09/2026-09-19-142227.jpg?enhanced';
	import w03 from '$lib/images/birds/2026/09/2026-09-19-163030.jpg?enhanced';
	import w04 from '$lib/images/birds/2026/09/2026-09-19-163842.jpg?enhanced';
		...
		[
			{
				image: w01,
				caption:
					'<strong>Yellow-rumped Warbler</strong><br/>Ellis Nature Farm, Lacombe, Alberta. September, 2026'
			},
			{
				image: w02,
				caption:
...
<div class="container">
	<div class="top-matter">
		...
		<div class="bird-type">{title} ({count.warblers})</div>
