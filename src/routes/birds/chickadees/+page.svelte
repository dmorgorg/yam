<script module>
	// american coot
	import ch01 from '$lib/images/birds/2026/09/2026-09-20-153858.jpg?enhanced';
	import ch02 from '$lib/images/birds/2026/09/2026-09-20-153938.jpg?enhanced';
		...
		[
			{
				image: ch02,
				caption:
					' <strong>Black-capped Chickadee</strong>. <br/>Telford Lake, Leduc County, Alberta. September, 2026'
			},
			{
				image: ch01,
				caption:
...
<div class="container">
	<div class="top-matter">
		...
		<div class="bird-type">{title} ({count.chickadees})</div>
